...
public:
  ...
  void testElementWiseMultiplication()
  {
    ...
    ArrayViewT< T const, 2, RAJA::PERM_IJ > const vectorC_IJ = m_vectorC_IJ.toViewConst();
    ArrayViewT< T const, 2, RAJA::PERM_JI > const vectorC_JI = m_vectorC_JI.toViewConst();
  ...
  void testSymAddIdentity()
  {
    ...
    ArrayViewT< T, 2, RAJA::PERM_IJ > const symMatrix_IJ = m_symMatrix_IJ.toView();
    ArrayViewT< T, 2, RAJA::PERM_JI > const symMatrix_JI = m_symMatrix_JI.toView();
