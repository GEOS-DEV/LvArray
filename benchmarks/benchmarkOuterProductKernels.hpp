...
private:
  static void fortranArrayKernel( Array< VALUE_TYPE, RAJA::PERM_I > const & a,
                                  Array< VALUE_TYPE, RAJA::PERM_I > const & b,
                                  Array< VALUE_TYPE, PERMUTATION > const & c );

  static void fortranViewKernel( ArrayView< VALUE_TYPE const, RAJA::PERM_I > const & a,
                                 ArrayView< VALUE_TYPE const, RAJA::PERM_I > const & b,
                                 ArrayView< VALUE_TYPE, PERMUTATION > const & c );

  static void fortranSliceKernel( ArraySlice< VALUE_TYPE const, RAJA::PERM_I > const a,
                                  ArraySlice< VALUE_TYPE const, RAJA::PERM_I > const b,
                                  ArraySlice< VALUE_TYPE, PERMUTATION > const c );

  static void subscriptArrayKernel( Array< VALUE_TYPE, RAJA::PERM_I > const & a,
                                    Array< VALUE_TYPE, RAJA::PERM_I > const & b,
                                    Array< VALUE_TYPE, PERMUTATION > const & c );

  static void subscriptViewKernel( ArrayView< VALUE_TYPE const, RAJA::PERM_I > const & a,
                                   ArrayView< VALUE_TYPE const, RAJA::PERM_I > const & b,
                                   ArrayView< VALUE_TYPE, PERMUTATION > const & c );

  static void subscriptSliceKernel( ArraySlice< VALUE_TYPE const, RAJA::PERM_I > const a,
                                    ArraySlice< VALUE_TYPE const, RAJA::PERM_I > const b,
                                    ArraySlice< VALUE_TYPE, PERMUTATION > const c );
...
public:
  ...
  void fortranView() const
  {
    ArrayView< VALUE_TYPE const, RAJA::PERM_I > const & a = this->m_a.toViewConst();
  ...
  void fortranSlice() const
  {
    ArraySlice< VALUE_TYPE const, RAJA::PERM_I > const & a = this->m_a.toSliceConst();
