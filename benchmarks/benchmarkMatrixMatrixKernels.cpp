...
{ MATRIX_MATRIX_KERNEL( a.get_layout().sizes[ 0 ], a.get_layout().sizes[ 1 ], b.get_layout().sizes[ 1 ], a( i, k ), b( k, j ), c( i, j ) ); }
...
RAJAViewKernel( RajaView< VALUE_TYPE const, PERMUTATION > const & a,
                RajaView< VALUE_TYPE const, PERMUTATION > const & b,
                RajaView< VALUE_TYPE, PERMUTATION > const & c )
{ MATRIX_MATRIX_KERNEL_RAJA( a.get_layout().sizes[ 0 ], a.get_layout().sizes[ 1 ], b.get_layout().sizes[ 1 ], a( i, k ), b( k, j ), c( i, j ) ); }
