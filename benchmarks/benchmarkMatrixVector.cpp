...
#define NATIVE_INIT \
  ...
  int iter = 0; \
  Array< VALUE_TYPE, PERMUTATION > a( N, M ); \
  initialize( a, iter ); \
  Array< VALUE_TYPE, RAJA::PERM_I > b( M ); \
  initialize( b, iter ); \
  Array< VALUE_TYPE, RAJA::PERM_I > c( N )
...
void fortranNative( benchmark::State & state )
{
  ...
  ArrayView< VALUE_TYPE const, RAJA::PERM_I > const & bView = b;
  ArrayView< VALUE_TYPE, RAJA::PERM_I > const & cView = c;
  for( auto _ : state )
  {
    MatrixVectorNative< PERMUTATION >::fortran( aView, bView, cView, N, M );
...
void subscriptNative( benchmark::State & state )
{
  ...
  for( auto _ : state )
  {
    MatrixVectorNative< PERMUTATION >::subscript( aView, bView, cView, N, M );
    benchmark::ClobberMemory();
  }
...
void rajaViewNative( benchmark::State & state )
{
  ...
  RajaView< VALUE_TYPE, RAJA::PERM_I > const cView = makeRajaView( c );
  for( auto _ : state )
  {
    MatrixVectorNative< PERMUTATION >::rajaView( aView, bView, cView, N, M );
    benchmark::ClobberMemory();
  }
...
void pointerNative( benchmark::State & state )
{
  ...
  for( auto _ : state )
  {
    MatrixVectorNative< PERMUTATION >::pointer( aView, bView, cView, N, M );
    benchmark::ClobberMemory();
  }
...
void fortranRAJA( benchmark::State & state )
{
  ...
  for( auto _ : state )
  {
    MatrixVectorRAJA< PERMUTATION, POLICY >::fortran( aView, bView, cView, N, M );
    benchmark::ClobberMemory();
  }
...
void subscriptRAJA( benchmark::State & state )
{
  ...
  for( auto _ : state )
  {
    MatrixVectorRAJA< PERMUTATION, POLICY >::subscript( aView, bView, cView, N, M );
    benchmark::ClobberMemory();
  }
...
void rajaViewRAJA( benchmark::State & state )
{
  ...
  for( auto _ : state )
  {
    MatrixVectorRAJA< PERMUTATION, POLICY >::rajaView( aView, bView, cView, N, M );
    benchmark::ClobberMemory();
  }
...
void pointerRAJA( benchmark::State & state )
{
  ...
  for( auto _ : state )
  {
    MatrixVectorRAJA< PERMUTATION, POLICY >::pointer( aView, bView, cView, N, M );
    benchmark::ClobberMemory();
  }
