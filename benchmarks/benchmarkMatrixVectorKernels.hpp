...
public:
  ...
  void fortranView() const
  {
    ...
    ArrayViewT< VALUE_TYPE, RAJA::PERM_I > const c = m_c.toView();
  ...
  void fortranSlice() const
  {
    ...
    ArraySliceT< VALUE_TYPE, RAJA::PERM_I > const c = m_c.toSlice();
...
protected:
  ...
  ArrayT< VALUE_TYPE, RAJA::PERM_I > m_c;
...
public:
  ...
  void fortranView() const
  {
    ...
    ArrayViewT< VALUE_TYPE, RAJA::PERM_I > const c = this->m_c.toView();
    TIMING_LOOP( fortranViewKernel( a, b, c ); )
  }
  ...
  void fortranSlice() const
  {
    ...
    ArraySliceT< VALUE_TYPE, RAJA::PERM_I > const c = this->m_c.toSlice();
    TIMING_LOOP( fortranSliceKernel( a, b, c ); )
  }
