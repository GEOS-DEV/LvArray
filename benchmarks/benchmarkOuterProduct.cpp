...
{
  OuterProductNative< PERMUTATION > const kernels( state, __PRETTY_FUNCTION__, resultsMap );
...
{
  OuterProductRAJA< PERMUTATION, POLICY > const kernels( state, __PRETTY_FUNCTION__, resultsMap );
  kernels.fortranView();
}
