...
{ OUTER_PRODUCT_KERNEL( c.get_layout().sizes[ 0 ], c.get_layout().sizes[ 1 ], a( i ), b( j ), c( i, j ) ); }
...
RAJAViewKernel( RajaView< VALUE_TYPE const, RAJA::PERM_I > const & a,
                RajaView< VALUE_TYPE const, RAJA::PERM_I > const & b,
                RajaView< VALUE_TYPE, PERMUTATION > const & c )
{ OUTER_PRODUCT_KERNEL_RAJA( c.get_layout().sizes[ 0 ], c.get_layout().sizes[ 1 ], a( i ), b( j ), c( i, j ) ); }
