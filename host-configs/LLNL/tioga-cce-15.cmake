...
set(CAMP_DIR "${GEOS_TPL_DIR}/camp-main" CACHE PATH "" )
set(RAJA_DIR "${GEOS_TPL_DIR}/raja-develop" CACHE PATH "" )

set(ENABLE_UMPIRE TRUE CACHE BOOL "" )
set(UMPIRE_DIR "${GEOS_TPL_DIR}/umpire-develop" CACHE PATH "" )

set(ENABLE_CHAI TRUE CACHE BOOL "" )
set(CHAI_DIR "${GEOS_TPL_DIR}/chai-develop" CACHE PATH "" )
