...
//         if (s == chai::CPU)
//         {
//           LVARRAY_LOG_RANK("Moved " << size << " to the CPU: " << typeString << " " << name );
//         }
//         else if (s == chai::GPU)
//         {
//           LVARRAY_LOG_RANK("Moved " << size << " to the GPU: " << typeString << " " << name );
//         }
//       }
//     });
// #else
...
//   {
//     LVARRAY_ASSERT( arrayManipulation::isPositive( newLength ) && newLength <= capacity());
//     m_length = newLength;
//   }
